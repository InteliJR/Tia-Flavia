export default function Media() {
    return (
        <div className='relative bg-[#F9E79F] flex flex-col md:flex-row text-2xl gap-x-8 md:gap-x-24 min-h-screen items-center justify-center py-8 px-6 overflow-hidden'>
            {/* Bolinhas decorativas */}
            <div className="absolute top-10 left-10 w-40 h-40 bg-[#FFEAA7] rounded-full z-0"></div> {/* Aumentei essa bolinha */}
            ...
            <div className='relative z-10 w-full md:w-2/5 mb-8 md:mb-0 text-left mt-[-100px]'>
                <h1 className='font-extrabold text-5xl md:text-6xl text-[#2C3E50] drop-shadow-lg'> {/* Aumentado e com sombra */}
                    Instituto Tia Flavia na <span className="underline decoration-blue-500">mídia</span>
                </h1> {/* O sublinhado azul foi adicionado apenas na palavra "mídia" */}
                ...
                </p> {/* Adicionada linha abaixo para destaque */}
            </div>

            <div className='relative z-10 flex flex-col md:flex-row gap-8 justify-center items-center w-full md:w-3/5'>
                <div className='text-center'>
                    <h2 className='text-2xl font-bold text-[#2C3E50] mb-4'>Entrevista com Tia Flávia</h2>
                    <iframe
                        width="400"
                        height="250"
                ...
                <div className='text-center'>
                    <h2 className='text-2xl font-bold text-[#2C3E50] mb-4'>Trabalho Social nas Comunidades</h2>
                    <iframe
                        width="400"
                        height="250"
